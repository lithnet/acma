    ...
    public class DBQueryGroupTest
    {
        ...
        public void DBQueryGroupOr()
        {
            ...
            try
            {
                ...
                List<MAObjectHologram> results = UnitTestControl.DataContext.GetMAObjectsFromDBQuery(queryGroup).ToList();
                ...
                results = UnitTestControl.DataContext.GetMAObjectsFromDBQuery(queryGroup).ToList();
