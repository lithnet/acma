        ...
        private void Validate()
        {
            switch (this.Operator)
            {
                ...
                case ValueOperator.GreaterThan:
                    ...
                    {
                        throw new ConfigurationException(string.Format("An attribute type of {0} cannot be used in a query with the query type of {1}", this.SearchAttribute.Type.ToSmartString(), this.Operator.ToSmartString()));
                    }
