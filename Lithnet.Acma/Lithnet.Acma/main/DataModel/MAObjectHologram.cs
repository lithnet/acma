...
namespace Lithnet.Acma
{
    ...
    public class MAObjectHologram : MAObject
    {
        ...
        private ObjectModificationType csEntryModType = ObjectModificationType.Unconfigured;
        ...
        internal ObjectModificationType CSEntryModificationType
        {
            get
            {
                return this.csEntryModType;
            }
        }
            ...
            set
            {
                ...
                switch (this.acmaModificationType)
                {
                    case TriggerEvents.Unconfigured:
                        this.csEntryModType = ObjectModificationType.Unconfigured;
                        break;

                    case TriggerEvents.Add:
                        this.csEntryModType = ObjectModificationType.Add;
                        break;

                    case TriggerEvents.Update:
                        this.csEntryModType = ObjectModificationType.Update;
                        break;

                    case TriggerEvents.Delete:
                        this.csEntryModType = ObjectModificationType.Delete;
                        break;
                    ...
                    case TriggerEvents.None:
                        this.csEntryModType = ObjectModificationType.None;
                        break;
