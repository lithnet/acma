        ...
        public Token Next()
        {
            ...
            switch (ch)
            {
                ...
                case '-':
                    {
                        ...
                        {
                            this.Consume();
                            return this.CreateToken(TokenKind.ReferenceOperator);
                        }
                        else
                        {
                            return this.CreateToken(TokenKind.Symbol);
                ...
                case '>':
                    {
                        ...
                        {
                            this.Consume();
                            return this.CreateToken(TokenKind.TransformOperator);
                        }
                        else
                        {
                            return this.CreateToken(TokenKind.Symbol);
                ...
                case '{':
                    this.StartRead();
                    this.Consume();
                    return this.CreateToken(TokenKind.OpenBrace);

                case '}':
                    this.StartRead();
                    this.Consume();
                    return this.CreateToken(TokenKind.ClosedBrace);
                ...
                case '%':
                    this.StartRead();
                    this.Consume();
                    return this.CreateToken(TokenKind.PercentSign);

                case '[':
                    this.StartRead();
                    this.Consume();
                    return this.CreateToken(TokenKind.OpenSquareBracket);

                case ']':
                    this.StartRead();
                    this.Consume();
                    return this.CreateToken(TokenKind.CloseSquareBracket);
