        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                if (this.IDs != null)
                {
                    ...
                    {
                        MAObjectHologram maobject = Global.DataContext.GetMAObjectOrDefault(id);
                ...
                {
                    IEnumerable<MAObjectHologram> objects = Global.DataContext.GetMAObjectsFromDBQuery(this.DBQuery);
