...
namespace Lithnet.Acma.DBInstaller
{
    public class DBInstallUpgrader
    {
        ...
        private static int dbMinorVersion = 6;

        private static int dbRevisionVersion = 8;
        ...
        public static void ValidateVersion(int major, int minor, int revision)
        {
        ...
        {
            string createScript = this.GetSqlScript("Scripts.New.CreateDB.sql");
            this.ExecuteSql(databaseName, createScript, "master", false);

            if (!string.IsNullOrWhiteSpace(syncServiceAccount))
            {
                string grantScript = this.GetSqlScript("Scripts.Other.GrantSyncServicePermissions.sql");
        ...
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_5_4.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, true);
        }

        private void UpgradeTo1_5_5(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_5_5.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, true);
        }

        private void UpgradeTo1_6_0(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_0.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, true);
        }

        private void UpgradeTo1_6_1(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_1.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, true);
        }

        private void UpgradeTo1_6_2(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_2.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, true);
        }

        private void UpgradeTo1_6_3(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_3.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, true);
        }

        private void UpgradeTo1_6_4(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_4.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, true);
        }

        private void UpgradeTo1_6_5(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_5.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, false);
        }

        private void UpgradeTo1_6_6(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_6.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, false);
        }

        private void UpgradeTo1_6_7(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_7.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, false);
        }

        private void UpgradeTo1_6_8(string databaseName)
        {
            string createScript = this.GetSqlScript("Scripts.Upgrades.1_6_8.sql");
            this.ExecuteSql(databaseName, createScript, databaseName, false);
        }
