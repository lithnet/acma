    ...
    public class MAObjectHologramTest
    {
        ...
        public void TestShadowProvisioning()
        {
            ...
            finally
            {
                ...
                {
                    ActiveConfig.DB.DeleteMAObjectPermanent(shadowId);
                }
            }
        }
        ...
        public void TestSubShadowProvisioning()
        {
            ...
            finally
            {
                ...
                {
                    ActiveConfig.DB.DeleteMAObjectPermanent(subShadowID);
                }
            }
        }
        ...
        public void TestSubShadowDeprovisioningBySubShadowDelete()
        {
            ...
            try
            {
                ...
                shadowObject = ActiveConfig.DB.GetMAObject(shadowId, shadowObjectClass);
        ...
        public void TestSubShadowDeprovisioningByShadowDelete()
        {
            ...
            try
            {
               ...
               subShadowObject = ActiveConfig.DB.GetMAObjectOrDefault(subShadowID);
        ...
        public void TestShadowDeprovisioningByShadowDelete()
        {
            ...
            try
            {
                ...
                sourceObject = ActiveConfig.DB.GetMAObjectOrDefault(newId);
        ...
        public void TestShadowDeprovisioningByParentDeprovisionTrigger()
        {
            ...
            try
            {
                ...
                shadowObject = ActiveConfig.DB.GetMAObjectOrDefault(shadowId);
        ...
        public void TestReferenceLinkCreateSingle()
        {
            ...
            try
            {
                MAObjectHologram childObject = ActiveConfig.DB.CreateMAObject(childId, "person");
                ...
                supervisorObject = ActiveConfig.DB.GetMAObjectOrDefault(supervisorId);
            ...
            {
                ActiveConfig.DB.DeleteMAObjectPermanent(childId);
        ...
        public void TestReferenceLinkCreateMulti()
        {
            ...
            try
            {
                MAObjectHologram child1Object = ActiveConfig.DB.CreateMAObject(child1Id, "person");
                MAObjectHologram child2Object = ActiveConfig.DB.CreateMAObject(child2Id, "person");
                MAObjectHologram supervisorObject = ActiveConfig.DB.CreateMAObject(supervisorId, "person");
        ...
        public void TestReferenceLinkDeleteMulti()
        {
            ...
            try
            {
                MAObjectHologram child1Object = ActiveConfig.DB.CreateMAObject(child1Id, "person");
                MAObjectHologram child2Object = ActiveConfig.DB.CreateMAObject(child2Id, "person");
                MAObjectHologram child3Object = ActiveConfig.DB.CreateMAObject(child3Id, "person");
                MAObjectHologram supervisorObject = ActiveConfig.DB.CreateMAObject(supervisorId, "person");
        ...
        public void TestReferenceLinkCreateTwoWay()
        {
            ...
            try
            {
                MAObjectHologram linkedAccount1 = ActiveConfig.DB.CreateMAObject(linkedAccount1Id, "person");
                linkedAccount1.SetAttributeValue(ActiveConfig.DB.GetAttribute("displayName"), "Account1");
                linkedAccount1.CommitCSEntryChange();

                MAObjectHologram linkedAccount2 = ActiveConfig.DB.CreateMAObject(linkedAccount2Id, "person");
                linkedAccount2.SetAttributeValue(ActiveConfig.DB.GetAttribute("displayName"), "Account2");
                linkedAccount2.CommitCSEntryChange();

                MAObjectHologram linkedAccount3 = ActiveConfig.DB.CreateMAObject(linkedAccount3Id, "person");
                ...
                linkedAccount1 = ActiveConfig.DB.GetMAObjectOrDefault(linkedAccount1Id);
                linkedAccount2 = ActiveConfig.DB.GetMAObjectOrDefault(linkedAccount2Id);
                linkedAccount3 = ActiveConfig.DB.GetMAObjectOrDefault(linkedAccount3Id);
            ...
            {
                ActiveConfig.DB.DeleteMAObjectPermanent(linkedAccount1Id);
                ActiveConfig.DB.DeleteMAObjectPermanent(linkedAccount2Id);
                ActiveConfig.DB.DeleteMAObjectPermanent(linkedAccount3Id);
            }
        }
        ...
        public void TestValueChangeMergeAddDelete()
        {
            ...
            try
            {
                MAObjectHologram sourceObject = ActiveConfig.DB.CreateMAObject(sourceObjectId, "person");
            ...
            {
                ActiveConfig.DB.DeleteMAObjectPermanent(sourceObjectId);
            }
        }
        ...
        public void TestSVDereferenceOnObjectDelete()
        {
            ...
            try
            {
                MAObjectHologram referencedObject = ActiveConfig.DB.CreateMAObject(referencedObjectID, objectClass);
                referencedObject.CommitCSEntryChange();

                MAObjectHologram referencingObject = ActiveConfig.DB.CreateMAObject(referencingObjectID, objectClass);
                ...
                referencingObject = ActiveConfig.DB.GetMAObject(referencingObjectID, objectClass);
            ...
            {
                ActiveConfig.DB.DeleteMAObjectPermanent(referencedObjectID);
                ActiveConfig.DB.DeleteMAObjectPermanent(referencingObjectID);
            }
        }
