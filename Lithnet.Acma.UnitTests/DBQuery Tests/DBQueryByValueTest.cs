    ...
    public class DBQueryByValueTest
    {
        ...
        public void DBQueryBySingleValueSVEquals()
        {
            ...
            try
            {
                ...
                List<MAObjectHologram> results = UnitTestControl.DataContext.GetMAObjectsFromDBQuery(group).ToList();
                ...
                results = UnitTestControl.DataContext.GetMAObjectsFromDBQuery(group).ToList();
