...
namespace Lithnet.Acma.UnitTests
{
    ...
    public class DeclarationStringTest
    {
        ...
        private bool IsAttributeUnique(MAObjectHologram maObject, IEnumerable<string> uniqueAllocationAttributes, string valueToTest)
        {
            ...
            {
                if (ActiveConfig.DB.DoesAttributeValueExist(attribute, valueToTest, maObject.ObjectID))
                {
                    return false;
                }
            }
        ...
        public void ExpandComplexSVStringWithMandatoryUniqueAllocationVariable()
        {
            ...
            try
            {
                MAObjectHologram existingObject = ActiveConfig.DB.CreateMAObject(existingId, "person");
            ...
            {
                ActiveConfig.DB.DeleteMAObjectPermanent(newId);
                ActiveConfig.DB.DeleteMAObjectPermanent(existingId);
            }
        }
        ...
        public void ExceptionOnMVAttributeInComplexString()
        {
            ...
            try
            {
                MAObjectHologram maObject = ActiveConfig.DB.CreateMAObject(newGuid, "person");
            ...
            {
                ActiveConfig.DB.DeleteMAObjectPermanent(newGuid);
            }
        }
