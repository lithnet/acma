...
namespace Lithnet.Acma.Presentation
{
    public class AdvancedComparisonRuleViewModel : RuleViewModel
    {
        ...
        private string GetDisplayName(bool truncate)
        {
            ...
            if (this.ValueOperator == ValueOperator.IsPresent || this.ValueOperator == ValueOperator.NotPresent)
            {
        ...
        public bool IsSecondValueAllowed
        {
            get
            {
                return this.ValueOperator != ValueOperator.NotPresent && this.ValueOperator != ValueOperator.IsPresent;
            }
        }
